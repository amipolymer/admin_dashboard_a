...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('employees_new_joiners', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('employees_new_joiners', 'emp_application_source')) {
                $table->string('emp_application_source', 80)->nullable()->after('emp_ongrid_profession_id');
            }
    ...
    {
        Schema::table('employees_new_joiners', function (Blueprint $table) {
            foreach (['emp_application_source_detail', 'emp_application_source', 'emp_ongrid_profession_id'] as $col) {
